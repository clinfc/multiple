...
<script>
/**
 * 1、在引入 bmap 扩展之前，需要在 HTML模板文件（/public/index.html） 中引入百度地图的 API。这也是不足之处
 *    <script type="text/javascript" src="//api.map.baidu.com/api?v=2.0&ak=kGNFvzccNhXtVfwGDi5iIQZtACfiViEB">
 * 2、引入 bmap 扩展
 */
